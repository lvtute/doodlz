...
public class MainActivityFragment extends Fragment {
    ...
    private DoodleView doodleView;//handle touch events and draw
...
//        return inflater.inflate(R.layout.fragment_main, container, false);
    ...
    // display the fragment's menu items
    @Override
    ...
    //requests the permission needed for saving the image if neccessary
    //or saves the image if the app already has permission
    private void saveImage() {
        // check if the app does not have permission needed to save the image
        if (getContext().checkSelfPermission(
                Manifest.permission.WRITE_EXTERNAL_STORAGE) !=
                PackageManager.PERMISSION_GRANTED) {

            // show an explaination of why permission is needed
            ...
            // if the app already has permission to write to external storage
